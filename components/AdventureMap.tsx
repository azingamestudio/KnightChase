...
const LEVELS: LevelConfig[] = [
    ...
    { id: 2, chapter: 1, type: 'PATH', title: "Direct Route", story: "The pencil broke, leaving debris. You need to reach the corner!", objective: "Reach (7,7) in 10 moves.", moveLimit: 10, goal: { x: 7, y: 7 }, initialBlocked: ["2,1", "1,2"], p1Start: { x: 0, y: 0 }, p2Start: { x: 4, y: 4 }, difficulty: 'easy' },
